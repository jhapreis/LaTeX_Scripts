...
\begin{titlepage}
 \vfill
  \begin{center}
   ...
   {\Large Relatório do experimento 4: Viscosidade e Lei de Stokes}\\[6cm] %Mudar o título do trabalho, conforme necessário
...
\large Campinas, outubro de 2019. 	%Mudar data, conforme necessário.
